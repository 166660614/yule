...
function showtanpai(){
    ...
    var msgxx={};
    msgxx.index=index;
    msgxx.img='/app/img/beastfish/point/win'+allcardxx['allniu'][index]+'.png';
...
function showothertanpai(data){
    if(data==index){
        ...
        var msgxx={};
        msgxx.index=data;
        msgxx.img='/app/img/beastfish/point/win'+allcardxx['allniu'][data]+'.png';
        showmemberBull(msgxx);
...
function adduser(data){
    ...
    var html='    <div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     html+='<img id="banker213612" src="/app/img/beastfish/bull_banker_bg.png" class="background jiurenniuniu-background" /> '
...
function operationButton(data){
    ...
    if(data=='9'){
        html+='<div class="operationButton-2-zt"><img style="width: 15vw;" src="/app/img/beastfish/readytxt.png"/></div>';
    }
...
function createRanking(data, func) {
    ...
    var width = 750;
    var height = 1216;
    var pics = ['/app/img/bull10/ranking_' + game_id + '_bg.jpg', '/app/img/beastfish/userbg.png', '/app/img/beastfish/winboss.png'];
    if (users.length > 16) {
