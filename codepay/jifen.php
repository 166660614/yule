...
require_once("jifencodepay_config.php"); //导入配置文件
...
if ((int)$codepay_config['id'] <= 1) { //未修改配置文件
    exit('<h3>您需要修改配置文件：jifencodepay_config.php 或者安装码支付接口 才能显示该页面。 <a href="install.php">点击安装</a></h3>');
} ?>
<!DOCTYPE html>
<html>
<head><title>
...
<div id="loadingPicBlock" style="max-width: 720px;margin:0 auto;" class="pay">
    <header class="g-header">
        ...
        <div class="head-r">
            <a href="/zhuye" class="z-HReturn" data-dismiss="modal" aria-hidden="true"><s></s><b>全天互娱首页</b></a>
        </div>
    </header>

    <div class="g-Total gray9">请选择充值金额（10元=1000张积分）<span style="color:red">新增支付宝接口充值</span></div>
 
    <section class="clearfix g-member">
        <div class="g-Recharge">
            <ul id="ulOption">
                <!--注意修改金额 需要同时修改前面的值 money="10" -->
                <li money="10"><a href="javascript:;">10元=1000积分<s></s></a></li>
                <li money="20"><a href="javascript:;">20元=2000积分<s></s></a></li>
                <li money="50"><a href="javascript:;"class="z-sel">50元=5000积分<s></s></a></li> <!--class="z-sel" 表示默认选中50元-->
                <li money="100"><a href="javascript:;">100元=10000积分<s></s></a></li>
                <li money="200"><a href="javascript:;">200元=20000积分<s></s></a></li>
                <li money="400"><a href="javascript:;">400元=40000积分<s></s></a></li>
               <li money="500"><a href="javascript:;">500元=50000积分<s></s></a></li>
            </ul>
        </div>
  ...
  <div> <span style="color:red"><font size="5"><b> PS:最近微信充值异常，无法充值的请使用支付宝充值。<br>支付宝充值方法：保存二维码到手机相册，再打开支付宝客户端扫描即可。</b></font></span></div><br>
  <div class="g-Total gray9" style="text-align: center;"><font color="#0000f0"><b><font size="5">QQ充值客服:380802971</font></b></font></div>
 <!-- <div><img src="/img/111.png" /></div><br>-->
   <div><font size="3">注意:用户充值10元 如果同一时间2人或多人一起充值10元,为了区分是谁付款,系统会要求支付10.01或10.02,实际支付可能跟原价会有出入,一般是几分的范围。<br>充值前请开启管理模式。<br>
