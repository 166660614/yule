...
//二维码超时设置  单位：秒
$codepay_config['outTime'] = 120;//360秒=6分钟 最小值60  不建议太长 否则会影响其他人支付
...
define('DB_USER', 'wx8790766');  //数据库用户名
define('DB_PWD', 'wx8790766');//数据库密码
define('DB_NAME', 'wx8790766');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'jz_user');  //充值用户所在数据库表名
define('DB_USERMONEY', 'credits');  //充值用户所在表中的金额字段名
