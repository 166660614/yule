...
define('DB_USER', 'yanshi_hmon_cn');  //数据库用户名
define('DB_PWD', 'FQ3ZYFjhjPsht4A4');//数据库密码
define('DB_NAME', 'yanshi_hmon_cn');  //数据库名称
...
define('DB_USERMONEY', 'fk');  //充值用户所在表中的金额字段名
