            ...
            <table class="table table-hover table-bordered table-list">
                ...
                <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr>
                        ...
                        <td>
                            ...
                            <a href='<?php echo U("AdminUser/edit",array("id"=>$vo["id"]));?>'>成员管理</a><br><br>
                            <a class="js-ajax-delete" href="<?php echo U('adminUser/delete',array('id'=>$vo['id']));?>">删除</a>|
                            <a href="/index.php/Portal/index/index/?token=<?php echo ($vo['token']); ?>" target="_blank">登录成员</a>
