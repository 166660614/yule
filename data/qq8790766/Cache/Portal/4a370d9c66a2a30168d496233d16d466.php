<?php if (!defined('THINK_PATH')) exit();?><html onapp="app" style="height: 100%;width: 100%;">
 <head> 
  ...
  <link rel="stylesheet" href="http://qq8790766.cdn.bcebos.com/a/css/loading.css" /> 
  <link rel="stylesheet" type="text/css" href="http://qq8790766.cdn.bcebos.com/a/css/homepage/vip.css" /> 
  <link rel="stylesheet" href="http://qq8790766.cdn.bcebos.com/a/css/homepage/xxxk.css" /> 
...
.sangongPart{position:fixed;bottom:88vw;left:0;width:100%;height:98vw;background-size:100% 100%;margin-bottom:-88vw;-webkit-transition:all .6s;transition:all .6s;z-index:99;}
 ...
 <div onclick="createRoom()" class="cjfj-puls"></div> 
  <img class="chuangjfj-bj" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/bg.jpg" /> 
  <img class="topImg" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/bg_up.png" />   
   <div class="user" >
...
<body>
          <div style="position: fixed;z-index: 1112; height: 12vw; width: 100vw; bottom: 0;background: url(http://qq8790766.cdn.bcebos.com/skin/xxxk/bg_under.png) no-repeat;background-size:100% 100%">
           <div>
                <img ng-click="gotozj()" style="width: 23vw; position: relative; top: -6.5vw;" src="/app/dy/youxidating.png">
            </div>
        </div>
        <div style="position: fixed;display:flex;justify-content: space-around;width: 100%;bottom: 0vw;z-index: 1113;">
            <div style="width:13vw">
            </div>           
            <div>
                <img ng-click="gotozj()" style="width: 13vw; position: relative; top: -3vw;" src="/app/dy/icon_zj.png" onclick="location.href='<?php echo U('portal/home/dashengkaifangchaxun');?>'" >
            </div>
            <div>
                <img ng-click="gotojl()" style="width: 13vw; position: relative; top: -3vw;" src="/app/dy/icon_jl.png" onclick="location.href='<?php echo U('portal/home/gerenzxkafangchaxun');?>'" >
            </div>
            <div>
                <img ng-click="gotored()" style="width: 13vw; position: relative; top: -3vw;" src="/app/dy/icon_fk.png" onclick="location.href='<?php echo U('/portal/user/fangka');?>'">
            </div>
            <div>
                <img ng-click="gotopage()" style="width: 13vw; position: relative; top: -3vw;" src="/app/dy/icon_wd.png" onclick="location.href='<?php echo U('/portal/user/index');?>'">
            </div>       				
	</div>
  <div style="width: 100%;height: auto; ">
  
  <img id="1" class="cjfj-home-img1" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/nn.png">
  <img id="2" class="cjfj-home-img2" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/jh.png">
  <img id="3" class="cjfj-home-img3" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/sg.png">
  <img src="http://qq8790766.cdn.bcebos.com/skin/xxxk/p9.png" class="cjfj-home-img4" onclick="send('gameserver',{id:27})">
  <img src="http://qq8790766.cdn.bcebos.com/skin/xxxk/28g.png" class="cjfj-home-img5" onclick="send('gameserver',{id:6})">
  <img src="http://qq8790766.cdn.bcebos.com/skin/xxxk/yxx.png" class="cjfj-home-img6" onclick="send('gameserver',{id:26})">  
  </div>
 <div class="createRoom" style="display: none" id="room"></div>
<div class="bullPart">
  <img class="img" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/6.png" onclick="send('gameserver',{id:1})">
  <img class="img" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/9.png" onclick="send('gameserver',{id:2})">
  <img class="img" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/12.png" onclick="send('gameserver',{id:10})">
  <div style="clear:both;"></div>
  </div>
  <div class="flowerPart">
  <img class="img" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/6.png" onclick="send('gameserver',{id:5})">
  <img class="img" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/9.png" onclick="send('gameserver',{id:16})"> 
   <div style="clear:both;"></div>
  </div>
  <div class="sangongPart">
  <img class="img" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/6.png" onclick="send('gameserver',{id:3})">
  <img class="img" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/9.png" onclick="send('gameserver',{id:4})">
  <img class="img" src="http://qq8790766.cdn.bcebos.com/skin/xxxk/12.png" onclick="send('gameserver',{id:17})">
   <div style="clear:both;"></div>
  </div>
  <div class="mm"></div>
  <script>
