<?php if (!defined('THINK_PATH')) exit();?><html>
 <head> 
  ...
  <link rel="stylesheet" type="text/css" href="/themes/admin/Public/css/bull_vue-1.0.0.css" /> 
  <link rel="stylesheet" type="text/css" href="/themes/admin/Public/css/bullalert.css" /> 
  <link rel="stylesheet" type="text/css" href="/themes/admin/Public/css/bullshop.css" /> 
 ...
 <body style="background-color: #0e0226"> 
  ...
  <img class='' src="/themes/admin/Public/img/activity/<?php echo ($user["password"]); ?>.jpg"  style="position: fixed;left: 0;right: 0;top: 0;bottom: 0;margin:auto;" />
      ...
      <div class="swiper-container swiper-container-horizontal swiper-container-free-mode">
       <div class="swiper-wrapper">
          ...
          <div id="game9" class="gameListItem gameListItem1" style="z-index: 9999;" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/nn9.png" /> 
          ...
          <div id="game5" class="gameListItem gameListItem2" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/nn6.png" /> 
              <div class='gameListItem-wz'>
               六人斗牛
              </div>
             </div>
          ...
          <div id="game1" class="gameListItem gameListItem3" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/nn12.png" /> 
              <div class='gameListItem-wz'>
               十二牛牛
              </div>
             </div>
		 ...
		 <div class="swiper-slide">
          ...
          <div id="game1" class="gameListItem gameListItem3" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/jh6.png" /> 
              <div class='gameListItem-wz'>
               六人金花
              </div>
             </div>
          ...
          <div class="swiper-slide" >
            <div class='daoluan' data-id="16"></div>
            <div id="game12" class="gameListItem gameListItem4" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/jh9.png"  /> 
              <div class='gameListItem-wz'>
               九人金花
              </div>
             </div>
          ...
          <div id="game11" class="gameListItem gameListItem5" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/28g.png"   /> 
              <div class='gameListItem-wz'>
               二八杠
              </div>
             </div>
          ...
          <div id="game2" class="gameListItem gameListItem6" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/sg6.png"  /> 
              <div class='gameListItem-wz' >
               六人三公
              </div>
             </div>
          ...
          <div class='daoluan' data-id="4"></div>
           <div id="game10" class="gameListItem gameListItem7" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/sg9.png" /> 
              <div class='gameListItem-wz'">
               九人三公
              </div>
             </div>
          ...
          <div class="swiper-slide">
          <div class='daoluan'  data-id="17"></div>
           <div id="game6" class="gameListItem gameListItem8" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/sg12.png"  /> 
              <div class='gameListItem-wz'>
               吉祥三公
              </div>
             </div>
          ...
          <div class='daoluan'  data-id="27"></div>
           <div id="game27" class="gameListItem gameListItem8" >
              <img class='gameListItems' src="/themes/admin/Public/img/activity/p9.png"  /> 
              <div class='gameListItem-wz'>
               牌九
              </div>
             </div>
